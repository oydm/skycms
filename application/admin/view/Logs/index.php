...
{include file="Common:Nav"/}
 <!-- -->
  ...
  <form method="post" action="{:Url('Admin/Logs/index')}">
  <div class="search_type cc mb10">
    ...
    时间：
      ...
      <a class="J_ajax_del btn" name="del_log_4" href="{:Url('Admin/Logs/del')}" >删除一月前数据</a>
      </span> </div>
      </form> 
  </div>
          ...
          {volist name="logs" id="vo"}
            <tr>
              ...
              <td align="center">
                ...
                {if condition="$vo['status'] eq 0"}<font color="#FF0000">失败</font>{/if}
          </td>
              <td align="">{$vo.info}</td>

...
<body class="J_scroll_fixed">
    <div class="wrap J_check_wrap">
        ...
        <div class="h_a">站点配置</div>
             ...
             <form method='post'  class="J_ajaxForm" action="{:Url('Admin/Config/email')}">
                ...
                <table width="100%"  class="table_form">
                    ...
                    <tbody id="smtpcfg" style="">
                        ...
                        <tr>
                            <th>AUTH LOGIN验证</th>
                            <th class="y-bg">
                                <input name="mail_auth" id="mail_auth" value="1" type="radio" {if condition=" $Site['mail_auth'] == '1' "} checked {/if}> 开启 
                                <input name="mail_auth" id="mail_auth" value="0" type="radio" {if condition=" $Site['mail_auth'] == '0' "} checked {/if}> 关闭
                            </th>
                    </tr>
                    <tr>
                        <th>验证用户名</th>

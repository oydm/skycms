  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav">
        ...
        <div class="login_info"><span class="mr10">{$group_name}： {$Think.session.user} </span><a class="J_ajax_url" href="{:url('Admin/Login/logout')}" class="mr10">[注销]</a><a href="/" class="home" target="_blank">前台首页</a><!--<a href="#?g=Member" class="home" target="_blank">会员中心</a>--><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
          <input size="15" placeholder="Hi！" id="J_search_keyword" type="text">
          <button type="button" name="keyword" id="J_search" value="" data-url="{:url('Admin/Menu/Find')}">搜索</button>
        </div></th>
    ...
    <tr class="content">
      ...
      <td id="B_frame" style="height:100%;"><div class="options"> <a href="" class="refresh" id="J_refresh" title="刷新">刷新</a> <a href="" id="J_fullScreen" class="full_screen" title="全屏">全屏</a> </div>
        ...
        <iframe id="iframe_default" src="{:url('main')}" style="height: 100%; width: 100%;display:none;" data-id="default" frameborder="0" scrolling="auto"></iframe></td>
    </tr>
  </table>
</div>
...
$("#deletecache").on('click',function(e){
    ...
    iframeJudge({
        elem: $(this),
        href: "{:url("admin/index/deletecache")}",
        id: "deletecache"
    });
});
//iframe 加载事件
...
var USUALL = [],
    ...
    SUBMENU_CONFIG ={$SUBMENU_CONFIG}, /*主菜单区*/
    imgpath = '',
    times = 0,
    getdescurl = '',
    searchurl = '',

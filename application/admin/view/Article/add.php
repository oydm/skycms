...
<body class="J_scroll_fixed">
    <div class="wrap jj">
        <div class="nav">
            <ul class="cc">
                <li ><a href="{:url("/Admin/article/index",array("catid"=>input('catid')))}">内容列表</a></li>
                <li class="current"><a href="{:url("/Admin/article/add",array("catid"=>input('catid')))}">添加内容</a></li>
            </ul>
        </div>
        <div class="common-form">
            <form method="post" class="J_ajaxForm" action="{:Url('Admin/Article/add')}">

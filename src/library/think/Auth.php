...
class Auth{
     ...
     */
    public function check($name, $uid, $type=array(2,3), $mode='url', $relation='or') {
    ...
    protected function getUserInfo($uid) {
        ...
        if(!isset($userinfo[$uid])){
             $userinfo[$uid]=Db::table($this->_config['AUTH_USER'])->where(array('uid'=>$uid))->table($this->_config['AUTH_USER'])->find();
        }
        return $userinfo[$uid];
    }

...
<div class="wrap jj">
    {include file="Common:Nav"/}
        <div class="common-form">
            <form method="post" class="J_ajaxForm" action="{:Url('Admin/Article/edit')}" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="islink" type="checkbox" id="islink"  value="1"  {if condition="$data['islink'] eq '1' "}checked{/if}>
                            ...
                            <tr>
                                <th>文章图片：</th>
                                <td><input type="text" name="thumb" id="image" class="input length_5" ondblclick='image_priview(this.value);' value="{$data.thumb}" style="float: left"  runat="server">&nbsp;

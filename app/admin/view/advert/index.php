...
<div class="wrap J_check_wrap">
    ...
    <form method="get" action="{:Url('Admin/Advert/index')}">
            ...
            <table width="100%" cellspacing="0">
                ...
                {volist name="data" id="vo"}
                    <tr>
                        ...
                        <td align="center" >
                                <a href="{:Url('Admin/Advert/edit',array('id'=>$vo['id']))}" >修改</a>
                                <a href="{:Url('Admin/Advert/delete',array('id'=>$vo['id']))}" class="J_ajax_del" >删除</a>
                        </td>
                    </tr>
                {/volist}
                </tbody>
        ...
        <div class="btn_wrap">
            <div class="btn_wrap_pd">
                <label class="mr20">
                    ...
                    <button class="btn btn_submit mr10 J_ajax_submit_btn" type="submit" data-action="{:Url('Admin/Advert/listorder')}"  name="submit" value="listorder" >排序</button>
                    <button class="btn btn_submit mr10 J_ajax_submit_btn" type="submit" data-action="{:Url('Admin/Advert/review')}" name="submit" value="review">审核</button>
                    <button class="btn btn_submit mr10 J_ajax_submit_btn" type="submit" data-action="{:Url('Admin/Advert/unreview')}" name="submit" value="unreview">取消审核</button>
                    <button class="btn btn_submit mr10 J_ajax_submit_btn" type="submit" data-action="{:Url('Admin/Advert/del')}" name="submit" value="del">删除</button>

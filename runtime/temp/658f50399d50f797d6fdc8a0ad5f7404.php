...
<?php } ?>
        ...
        <form name="myform" id="myform" action="<?php echo Url('Admin/Category/add'); ?>" class="J_ajaxForm" method="post" enctype="multipart/form-data">

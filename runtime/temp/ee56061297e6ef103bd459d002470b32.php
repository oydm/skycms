<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"F:\www\bhwz\2.0.1\public/../app/super\view\channel\channel_add.php";i:1514974597;s:58:"F:\www\bhwz\2.0.1\public/../app/admin\view\Common\Head.php";i:1514947352;s:59:"F:\www\bhwz\2.0.1\public/../app/admin\view\Common\Cssjs.php";i:1503375391;s:57:"F:\www\bhwz\2.0.1\public/../app/admin\view\Common\Nav.php";i:1503375391;s:56:"F:\www\bhwz\2.0.1\public/../app/admin\view\Common\Js.php";i:1503375391;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="UTF-8">
...
<?php } ?>
    <div class="common-form">
        <form action="<?php echo Url('super/channel/channel_add'); ?>" method="post" class="J_ajaxForm">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="select_2" name="changeChannelId">
                                <option value="" >请选择支付渠道</option>
                                <?php if(is_array($changeChannel) || $changeChannel instanceof \think\Collection): $i = 0; $__LIST__ = $changeChannel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $vo['id']; ?>" ><?php echo $vo['channelName']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </td>
            ...
            <div class="btn_wrap">
                <div class="btn_wrap_pd">
                    <input type="hidden" name="gameId" id="gameId" class="input" value="<?php echo $gameId; ?>">

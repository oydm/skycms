<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"F:\www\thinkphp\public/../application/admin\view\logs\index.php";i:1497520504;s:64:"F:\www\thinkphp\public/../application/admin\view\Common\Head.php";i:1484295982;s:65:"F:\www\thinkphp\public/../application/admin\view\Common\Cssjs.php";i:1488264017;s:63:"F:\www\thinkphp\public/../application/admin\view\Common\Nav.php";i:1500620345;s:62:"F:\www\thinkphp\public/../application/admin\view\Common\Js.php";i:1501140469;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="UTF-8">
...
<?php } ?>
 <!-- -->
  ...
  <form method="post" action="<?php echo Url('Admin/Logs/index'); ?>">
  <div class="search_type cc mb10">
    ...
    时间：
      ...
      <a class="J_ajax_del btn" name="del_log_4" href="<?php echo Url('Admin/Logs/del'); ?>" >删除一月前数据</a>
      </span> </div>
      </form> 
  </div>
        ...
        <tbody>
          <?php if(is_array($logs) || $logs instanceof \think\Collection): $i = 0; $__LIST__ = $logs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
              ...
              <td align="center">
                <?php if($vo['status'] == 1): ?>成功<?php endif; if($vo['status'] == 0): ?><font color="#FF0000">失败</font><?php endif; ?>
          </td>

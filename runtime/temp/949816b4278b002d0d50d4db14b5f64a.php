<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"F:\www\thinkphp\public/../application/admin\view\article\edit.php";i:1501923700;s:64:"F:\www\thinkphp\public/../application/admin\view\Common\Head.php";i:1484295982;s:65:"F:\www\thinkphp\public/../application/admin\view\Common\Cssjs.php";i:1488264017;s:63:"F:\www\thinkphp\public/../application/admin\view\Common\Nav.php";i:1500620345;s:62:"F:\www\thinkphp\public/../application/admin\view\Common\Js.php";i:1501140469;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="UTF-8">
...
<?php } ?>
        <div class="common-form">
            <form method="post" class="J_ajaxForm" action="<?php echo Url('Admin/Article/edit'); ?>" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="islink" type="checkbox" id="islink"  value="1"  <?php if($data['islink'] == '1'): ?>checked<?php endif; ?>>
                            ...
                            <tr id="linktr">
                                <th width="80">外部链接</th>
                                <td>
                                    <input type="text" name="url" class="input length_6 input_hd" placeholder="请输入链接" id="url" value="<?php echo $data['url']; ?>">
                            ...
                            <tr>
                                <th>文章图片：</th>
                                <td><input type="text" name="thumb" id="image" class="input length_5" ondblclick='image_priview(this.value);' value="<?php echo $data['thumb']; ?>" style="float: left"  runat="server">&nbsp;
                                ...
                                <td>
                                    <fieldset class="blue pad-10">
                                        ...
                                        <ul id="albums" class="picList">
                                          <?php if(!(empty($imglist) || ($imglist instanceof \think\Collection && $imglist->isEmpty()))): if(is_array($imglist) || $imglist instanceof \think\Collection): $i = 0; $__LIST__ = $imglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                   <li id='imglist<?php echo $i; ?>'><input type='text' name='imglist[]' value='<?php echo $vo; ?>' style='width:310px;' class='input' ondblclick='image_priview(this.value);'><a href="javascript:remove_div('imglist<?php echo $i; ?>')">移除</a></li>

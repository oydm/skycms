<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\www\thinkphp\public/../application/admin\view\login\index.php";i:1501915699;}*/ ?>
<!doctype html>
<html>
    <head>
        <meta charset="GBK" />
    ...
    <body>
        <div class="wrap">
            ...
            <form method="post" action="<?php echo url('login'); ?>" id="RegForm" name="RegForm" class="J_ajaxForm">
                <div class="login">
                    <ul>
                        <li>
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <div class="yanzhengma_box" id="verifyshow"><img class="verifyimg reloadverify" style=" cursor: pointer;" align="right"  src="<?php echo url('verify'); ?>" title="点击刷新"> </div>
                        </li>
                    </ul>

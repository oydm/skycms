<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\www\thinkphp\public/../application/index\view\index\index.php";i:1501924294;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="index_new">
            ...
            <div class="index_new_main">
                ...
                <ul id="index_new_ul">
                    ...
                    <li class="index_new_li <?php if($k == '3'): ?>noli_ubderline<?php endif; ?>">
                        <span class="index_new_content">
                            <a  href="/news/<?php echo $vo['id']; ?>"><?php echo $vo['sortitle']; ?></a>
                            <i><?php echo date("m-d",$vo['inputtime']); ?></i>
                        </span>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <div class="index_page">
                    <input name="cur_page" id="cur_page" value="<?php echo $cur_page; ?>" type="hidden">
